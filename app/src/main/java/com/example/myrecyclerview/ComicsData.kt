...
object ComicsData {
    ...
    private val comicImages = intArrayOf(R.drawable.aot,
    ...
    val listData: ArrayList<Comic>
        get() {
            ...
            for (position in comicTitles.indices) {
                ...
                comic.photo = comicImages[position]
                list.add(comic)
            }
            return list
        }
